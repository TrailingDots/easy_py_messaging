...
class RunTests(unittest.TestCase):
    ...
    def testConfigSettings(self):
        ...
        """
        abs_path_server = os.path.abspath('../lib/logCollector.py')
        abs_path_app = os.path.abspath('../lib/loggingClientTask.py')
    ...
    def testLoggingSpeed(self):
        ...
        abs_path_server = os.path.abspath('../lib/logCollector.py')
        abs_path_app = os.path.abspath('../lib/loggingSpeedTest.py')
...
def suite():
    test_suite = unittest.makeSuite(RunTests)
    test_log_csv_parser_suite = unittest.makeSuite(TestLogs2CSV)
    test_log_json_parser_suite = unittest.makeSuite(TestLogs2JSON)
    test_log_levels_suite = unittest.makeSuite(TestLogLevelsPriorities)
    test_iso8601_suite = unittest.makeSuite(TestISO8601)
    return unittest.TestCaseSuite(( \
            test_suite,
            test_log_csv_parser_suite,
            test_log_json_parser_suite,
            test_log_levels_suite,
            test_iso8601_suite,
            ))
...
if __name__ == '__main__':
    ...
    unittest.main()
    logging.info('Unit test Finished')
