...
setup_args = dict(
        ...
        scripts=[
            'simple_log_messaging/simple_log_messaging/bin/logCollector',
            'simple_log_messaging/simple_log_messaging/bin/logFilterApp',
            'simple_log_messaging/simple_log_messaging/bin/logCmd',
            'simple_log_messaging/simple_log_messaging/bin/listeningPort'
        ],
        classifiers = [
